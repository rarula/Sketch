...
# overworld
    execute if data storage sketch: callback{slot:10b} if dimension minecraft:overworld run item replace block 10000 0 10000 container.0 with minecraft:red_stained_glass[custom_name='"overworld"']
    ...
    execute if data storage sketch: callback{slot:10b} unless dimension minecraft:overworld run item replace block 10000 0 10000 container.0 with minecraft:lime_stained_glass[custom_name='"overworld"']
...
# the end
    execute if data storage sketch: callback{slot:12b} if dimension minecraft:the_end run item replace block 10000 0 10000 container.0 with minecraft:red_stained_glass[custom_name='"the end"']
    ...
    execute if data storage sketch: callback{slot:12b} unless dimension minecraft:the_end run item replace block 10000 0 10000 container.0 with minecraft:lime_stained_glass[custom_name='"the end"']
