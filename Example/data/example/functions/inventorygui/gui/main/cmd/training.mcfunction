#> example:inventorygui/gui/main/cmd/training
# @within function example:inventorygui/gui/main/cmd/check
...
# メッセージ
    tellraw @a [{"color":"gold","selector":"@s"},{"text":" switched to sclattest"}]
