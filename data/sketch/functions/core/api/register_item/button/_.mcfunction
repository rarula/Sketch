...
# Add to each Map
    execute if data storage sketch:data in{isGlobal:0b} run function sketch:core/api/register_item/button/register_local_item
    execute if data storage sketch:data in{isGlobal:1b} run function sketch:core/api/register_item/button/register_global_item
