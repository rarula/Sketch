...
# 変更のあったスロットを確認しそれぞれの処理へ
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:0b}]
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:1b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:2b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:3b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:4b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:5b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:6b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:7b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:8b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:9b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:10b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:11b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:12b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:13b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:14b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:15b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:16b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:17b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:18b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:19b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:20b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:21b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:22b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:23b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:24b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:25b}]
    data remove storage sketch:temp Success
    ...
    execute if data storage sketch:temp {Success:true} run data modify storage sketch: out.item set from storage sketch:temp LastInv[{Slot:26b}]
    data remove storage sketch:temp Success

# idを更新
    data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Sketch.id set from storage sketch: out.item.tag.Sketch.id

# コールバック時に渡すデータを設定
    data remove storage sketch:temp CloneNewInv[{tag:{Sketch:{}}}]
    data modify storage sketch: out.items set from storage sketch:temp CloneNewInv
