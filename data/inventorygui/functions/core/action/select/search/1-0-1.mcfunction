...
execute if data storage inventorygui:core/action/select {Success:{3:false}} run data modify storage inventorygui: id set from storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].InventoryGui.Items[{Slot:9b}].tag.InventoryGui.id
