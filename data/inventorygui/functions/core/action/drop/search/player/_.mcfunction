...
# 実行者のUUIDと一致するか確認
    execute store success storage inventorygui:core/action/drop _.Success byte 1.0 run data modify storage inventorygui:core/action/drop _.VerifyUUID set from entity @s UUID
